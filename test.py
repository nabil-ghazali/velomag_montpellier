...
ECOCOUNTER_URN = "urn:ngsi-ld:EcoCounter:XTH19101158"
...
FROM_DATE_STR = "2025-01-01T00:00:00"
...
TO_DATE_STR = "2025-11-24T23:59:59" 
...
def get_traffic_in_range(eco_urn: str, from_date: str, to_date: str):
    ...
    try:
        ...
        if data and isinstance(data, list) and len(data) > 0:
            print(f"Total d'enregistrements reçus : {len(data)}")
            # Afficher le premier enregistrement pour vérifier le format
            print(json.dumps(data[0], indent=2))
        else:
            print(" Aucune donnée reçue. Vérifiez l'URN du compteur ou la plage de dates.")
...
if __name__ == "__main__":
    ...
    get_traffic_in_range(ECOCOUNTER_URN, FROM_DATE_STR, TO_DATE_STR)